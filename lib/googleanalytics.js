...
exports.getHitsPerPath  = function(token,profile,startDate,endDate,paths,callback) {
  exports.gaDataCall(token,profile,startDate,endDate,paths,['ga:hits'],['ga:pagePath'],callback);  
}

exports.getSocialPostsPerPath  = function(token,profile,startDate,endDate,paths,callback) {
  exports.gaDataCall(token,profile,startDate,endDate,paths,['ga:socialInteractions'],['ga:pagePath'],callback);  
}
