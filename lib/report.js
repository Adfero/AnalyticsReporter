  ...
  async.waterfall(
            ...
            if (err) {
              ...
              if (results.page) {
                ...
                outData.pages[reporter.name] = _.object(
                  ...
                  inData.urls.map(function(url) { return 0; })
                );
              }
    ...
    function(err,inData,outData) {
      if (err) {
        ...
        done(null,exports.calculateScores(inData,outData),outData);
      }
    }
  );
}

exports.calculateScores = function(inData,outData) {
  return inData.urls.map(function(url) {
